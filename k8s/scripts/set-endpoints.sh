...
export HASURA_METADATA_DATABASE_URL="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${DOMAIN}:${POSTGRES_NODEPORT}/${POSTGRES_DB}"
export HASURA_GRAPHQL_DATABASE_URL="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${DOMAIN}:${POSTGRES_NODEPORT}/${POSTGRES_DB}"
export PG_URL="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${DOMAIN}:${POSTGRES_NODEPORT}/${POSTGRES_DB}"
